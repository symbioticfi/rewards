...
public class IDefaultOperatorRewardsFactory.abi extends Contract {
    ...
    @Deprecated
    protected IDefaultOperatorRewardsFactory.abi(String contractAddress, Web3j web3j,
    ...
    public RemoteFunctionCall<TransactionReceipt> create() {
    ...
    @Deprecated
    public static IDefaultOperatorRewardsFactory.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new IDefaultOperatorRewardsFactory.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IDefaultOperatorRewardsFactory.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new IDefaultOperatorRewardsFactory.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static IDefaultOperatorRewardsFactory.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new IDefaultOperatorRewardsFactory.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static IDefaultOperatorRewardsFactory.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IDefaultOperatorRewardsFactory.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
